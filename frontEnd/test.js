...
!function (t) {
    ...
    var i = {}, r = {}, o = [], a = window.Webflow || [], s = window.jQuery, u = s(window), c = s(document),
        f = s.isFunction, l = i._ = n(4), d = i.tram = n(1) && s.tram, h = !1, p = !1;
    ...
    window.tram = function (t) {
        ...
        var f = function (t, e, n) {
            ...
            }, h = document, p = window, m = "bkwld-tram", v = /[\-\.0-9]/g, w = /[A-Z]/, b = "number", g = /^(rgb|#)/,
            y = /(em|cm|mm|in|pt|pc|px)$/, x = /(em|cm|mm|in|pt|pc|px|%)$/, _ = /(deg|rad|turn)$/, E = "unitless",
            k = /(all|none) 0s ease 0s/, L = /^(width|height)$/, A = " ", S = h.createElement("a"),
            z = ["Webkit", "Moz", "O", "ms"], $ = ["-webkit-", "-moz-", "-o-", "-ms-"], T = function (t) {
        ...
        var G = t.style, K = t.css, U = {transform: j.transform && j.transform.css}, Y = {
            color: [N, g],
    ...
    i.define("brand", t.exports = function (t) {
        ...
        return n.ready = function () {
            ...
            /\.webflow\.io$/i.test(h) && u.hostname !== h && (s = !0), s && !c && (e = e || (n = t('').attr("", ""), i = t("").attr("", "").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
            }), a = t("").attr("", "").attr("", ""), n.append(i, a), n[0]), d(), setTimeout(d, 500), t(r).off(f, l).on(f, l))
        }, n
    })
}, function (t, e, n) {
    "use strict";
    ...
    i.define("edit", t.exports = function (t, e, n) {
        ...
        var r, o = t(window), a = t(document.documentElement), s = document.location, u = "hashchange",
            c = n.load || function () {
                r = !0, window.WebflowEditor = !0, o.off(u, l), function (t) {
    ...
    i.define("links", t.exports = function (t, e) {
        var n, r, o, a = {}, s = t(window), u = i.env(), c = window.location, f = document.createElement("a"),
            l = "w--current", d = /index\.(html|php)$/, h = /\/$/;
    ...
    i.define("scroll", t.exports = function (t) {
        var e = {WF_CLICK_EMPTY: "click.wf-empty-link", WF_CLICK_SCROLL: "click.wf-scroll"}, n = window.location,
            ...
            f = "header, " + c + " > .header, " + c + " > .w-nav:not([data-no-scroll])", l = 'a[href="#"]',
            d = 'a[href*="#"]:not(.w-tab-link):not(' + l + ")", h = document.createElement("style");
                    ...
                    d.length && (e && (e.preventDefault(), e.stopPropagation()), function (t) {
                        ...
                        !function (e, n) {
                            var i = o.scrollTop(), r = function (e) {
                                var n = t(f), i = "fixed" === n.css("position") ? n.outerHeight() : 0,
                                    r = e.offset().top - i;
